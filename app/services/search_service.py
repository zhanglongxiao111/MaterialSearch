...
class SearchService:
    ...
    def _library_context(self):
        if self.target.startswith('proj_'):
            return 'project', self.target
    ...
    def search_images_by_text(
        ...
        library_type, project_id = self._library_context()
    ...
    def calculate_similarity(self, text: str, image_source) -> float:
